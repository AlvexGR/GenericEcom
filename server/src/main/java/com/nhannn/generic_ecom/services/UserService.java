...
public class UserService implements IUserService {
    ...
    public AuthenticatedUser login(String email, String password, Boolean rememberMe) {
        try {
            ...
            UserDetails userDetails = jwtUserDetailsService.loadUserByUsername(password);
            String token = jwtToken.generateToken(userDetails, rememberMe);
            AuthenticatedUser authenticatedUser = (AuthenticatedUser) userRepository.getByEmail(email);
